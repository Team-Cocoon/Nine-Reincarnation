...
namespace Enemy.Move
{
    public class MovingPlatform : MonoBehaviour
    {
        ...
        private void OnValidate()
        {
            ...
            {
                _rb2d.position = _waypoints[0].position;
            }
        }
        ...
        private void Start()
        {
            ...
            _origPosition = _rb2d.position;
            _origLocalPosition = _rb2d.transform.localPosition;
        ...
        {
            Vector3 center = _rb2d.transform.localPosition - new Vector3(0, _circleRadius, 0);
        ...
        {
            Vector3 center = _rb2d.transform.localPosition - new Vector3(0, _elipseRadiusY, 0);
            _angleRad *= Mathf.Deg2Rad;
        ...
        private void MoveLineOpen()
        {
            ...
            _rb2d.transform.localPosition = _waypoints[0].position;
            ...
            for (int i = 1; i < wayPointsCount; ++i)
            {
                ...
                {
                    seq.Append(_rb2d.DOMove(_waypoints[i].position, _duration).SetEase(_animaionType));
                }
                else //그 외
                {
                    seq.Append(_rb2d.DOMove(_waypoints[i].position, _duration).SetEase(Ease.Linear));
                }
            }
        ...
        private void MoveLineClosed()
        {
            ...
            seq.Append(_rb2d.DOMove(_waypoints[0].position, _duration).SetEase(_animaionType));
        ...
        public void ResetToInitialState()
        {
            ...
            {
                Vector3 targetPos = _waypoints.Count > 0 ? _waypoints[0].position : _origPosition;
                _rb2d.position = targetPos;
                if (_rb2d != null) _rb2d.position = targetPos;
            }
            else
            {
                _rb2d.transform.localPosition = _origLocalPosition;
                if (_rb2d != null) _rb2d.position = _rb2d.position;
            }
        ...
        {
            Vector3 centerPosition = _rb2d.transform.localPosition - new Vector3(0, _elipseRadiusY, 0);
        ...
        {
            Vector3 centerPosition = _rb2d.transform.localPosition - new Vector3(0, _circleRadius, 0);
        ...
        private void DrawLineOpen()
        {
            for (int i = 0; i < _waypoints.Count; i++)
            {
                ...
                Vector3 nextPoint = _waypoints[(i + 1) % _waypoints.Count].position;
                if (i != _waypoints.Count - 1)
                    Gizmos.DrawLine(_waypoints[i].position, nextPoint);

                Gizmos.DrawSphere(_waypoints[i].position, _handleRadius / 2);
            }
        }
        ...
        {
            return UnityEditor.Selection.activeGameObject == _rb2d.gameObject;
        }
#else
        private bool IsSelected()
        {
